 ...
 *
 * This file is a MODIFIED derivative of firmware/captive-portal.h from the
 ...
 *   - Rebranded the served control page from Sesame to Yuki.
 *   - Trimmed the page and adapted its controls to the command set and
 *     endpoints this firmware actually implements.
 * ---------------------------------------------------------------------
 */
