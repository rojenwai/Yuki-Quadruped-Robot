...
inline void setFace(const String& faceName) {}

inline void setFaceMode(FaceAnimMode mode) {}

inline void setFaceWithMode(const String& faceName, FaceAnimMode mode) {}

inline void delayWithFace(unsigned long ms) {
  delay(ms);
}

inline void enterIdle() {}
